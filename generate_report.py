...
def gen_case_rows(cases, include_opt=False):
    ...
    for case in cases:
        cells = case[:9]
        if include_opt:
            cells = cells + [case[9] if len(case) > 9 else ""]
